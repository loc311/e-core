package com.micro.product.controller.exception;
...
import com.micro.product.dto.Error;
import com.micro.product.dto.ResponseGeneral;
import com.micro.product.exception.base.BaseException;
...
public class ManagementException {
    ...
    public ResponseEntity<ResponseGeneral<Error>> handleValidationExceptions(
        ...
        String language = Objects.nonNull(webRequest.getHeader(LANGUAGE)) ? webRequest.getHeader(LANGUAGE)
                : DEFAULT_LANGUAGE;
